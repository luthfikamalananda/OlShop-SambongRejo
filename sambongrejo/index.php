            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section-heading">
                        ...
                        <a href="login-form-20/index.php">pesan sekarang <i class="fa fa-angle-right"></i></a>
                    </div>
                </div>
                <?php
                ...
                ?>
                    <div class="col-md-4">
                        <div class="product-item">
                            <a href="login-form-20/index.php"><img src="<?php echo $foto ?>" alt=""></a>
                            <div class="down-content">
                                <a href="login-form-20/index.php">
                                    <h4><?php echo $nama ?></h4>
                                </a>
