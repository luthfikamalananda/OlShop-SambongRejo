...
pengirim, tanggal, linkfoto FROM berita WHERE id_berita='$id_berita'";
...
$foto = stripslashes($hasil['linkfoto']);
//proses edit berita
if (isset($_POST['Edit'])) {
	...
	$fotoed = stripslashes($_POST['fotoed']);
	//update berita
	$query = "UPDATE berita SET id_kategori='$kategori',judul='$judul',headline='$headline',
isi='$isi_berita',pengirim='$pengirim', linkfoto='$fotoed' WHERE id_berita='$id_berita'";
	$sql = mysqli_query($con, $query);
	if ($sql) {
...
rows="10">---</textarea></td> -->
			...
			<tr>
				<td>Link Foto</td>
				<td>: <input type="text" name="fotoed" size="30" value="<?= $foto ?>"></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td>&nbsp;&nbsp;
