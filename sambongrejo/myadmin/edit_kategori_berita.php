...
$query = "SELECT * FROM kategori WHERE id_kategori='$id_berita'";
$sql = mysqli_query ($con,$query);
$hasil = mysqli_fetch_array ($sql);
$id_kategori = stripslashes ($hasil['id_kategori']);
$judul = stripslashes ($hasil['nm_kategori']);
...
//update berita
$query = "UPDATE kategori SET nm_kategori='$judul',deskripsi='$headline' WHERE id_kategori='$id_berita'";
$sql = mysqli_query ($con,$query);
if ($sql) {
//	echo "<h2><font color=blue>Berita telah berhasil diedit</font></h2>";
	...
	<script language="JavaScript">  
		alert('Data berhasil di update......');  
 		document.location='index.php?page=kategori_berita';  
	</script>
<?php	
} else {
...
?>
<html>
<head><title>Edit Kategori Berita</title>
<script language="JavaScript">  
function batal(){
 		document.location='index.php?page=kategori_berita';  
}		
...
<div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-laptop"></i>Edit Kategori Berita</li>						  	
					</ol>
				</div>
			</div>
