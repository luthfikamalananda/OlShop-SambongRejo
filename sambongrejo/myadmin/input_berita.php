...
if (isset($_POST['Input'])) {
	...
	$linkfoto = addslashes(strip_tags($_POST['linkfoto']));
	$pengirim = addslashes(strip_tags($_POST['pengirim']));
	//insert ke tabel
	$query = "INSERT INTO berita(id_kategori,judul,headline,isi,pengirim,linkfoto,tanggal) 
VALUES('$kategori','$judul','$headline','$isi_berita','$pengirim','$linkfoto',now())";
...
value='$hasil[id_kategori]'>$hasil[nm_kategori]</option>";
			...
			<tr>
				<td>Link Foto</td>
				<td>: <input type="text" name="linkfoto" size="50">
				</td>
			</tr>
			<tr>
				<td>Pengirim</td>
